...
class Brain:
    def __init__(self, factor_size, k, l, window_length, channel_size, learning_rate=LEARNING_RATE):
        self.model = GLOW(factor_size, k, l, window_length, channel_size)
    ...
    def forward(self, inputs):
        return self.model(inputs, logdet=True)[0]
